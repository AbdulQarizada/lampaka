...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mt-5 text-center">
                        <p>© <script> document.write(new Date().getFullYear()) </script> Qarizada. Developed with <i class="mdi mdi-heart text-danger"></i> by AbdulQarizada</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\TheStranger\Desktop\Projects\LampakaByte\LampakaByte Website\LampakaByte\resources\views/auth/login.blade.php ENDPATH**/ ?>